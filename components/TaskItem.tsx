...
import { TrashIcon, CalendarIcon, CheckIcon, PencilIcon, ListIcon } from './Icons';
...
const TaskItem: React.FC<TaskItemProps> = ({ task, projects, onSelectTask, onDeleteTask, onComplete, isFocused }) => {
    ...
    >
      ...
      <div className="flex-grow">
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-2 text-sm text-slate-400">
          ...
          {task.notes && (
            <span className="flex items-center gap-1.5" title="This task has notes">
