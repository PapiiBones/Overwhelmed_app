...
export const ChatBubbleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-.388m-5.168-4.47-1.423-1.423a2.25 2.25 0 0 1 0-3.182l2.25-2.25a2.25 2.25 0 0 1 3.182 0l1.423 1.423m-8.625 7.5 2.25-2.25m0 0a2.25 2.25 0 0 1 3.182 0l2.25 2.25a2.25 2.25 0 0 1 0 3.182l-2.25 2.25a2.25 2.25 0 0 1-3.182 0l-2.25-2.25a2.25 2.25 0 0 1 0-3.182Z" />
    </svg>
);
...
export const FolderIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h16.5m-16.5 3.75h16.5M3.75 17.25h16.5M2.25 8.25C2.25 7.56 2.81 7 3.5 7h17c.69 0 1.25.56 1.25 1.25v9c0 .69-.56 1.25-1.25 1.25h-17A1.25 1.25 0 0 1 2.25 17.25v-9Z" />
  </svg>
);
